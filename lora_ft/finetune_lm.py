...
def main():
    ...
    # raw_datasets = load_dataset('allenai/c4', data_files={'train': 'en/c4-train.00000-of-01024.json.gz', 'validation': 'en/c4-validation.00000-of-00008.json.gz'})
    raw_datasets = load_dataset('json', data_files={
    'train': 'c4/c4-train.00000-of-01024.json.gz',
    'validation': 'c4/c4-validation.00000-of-00008.json.gz'
    })
